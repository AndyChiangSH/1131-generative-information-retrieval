...
if __name__ == "__main__":
    CONFIG = {
        "train_path": "image_captioning/dataset/git-large-coco_1/train.jsonl",
        "test_path": "image_captioning/dataset/git-large-coco_1/test.jsonl",
        "test_images_path": "image_captioning/dataset/git-large-coco_1/test_images.jsonl",
        "submission_path": "retriever/submission/TF-IDF_5.csv",
        "log_path": "retriever/log/TF-IDF_5.log"
    }
